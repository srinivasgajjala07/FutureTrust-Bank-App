...
String raccno = (String) request.getAttribute("raccno");
%>

<div class="message">
Your Transfer was processed successfully. Below are the details:
</div>
...
<p><span>Receiver Account Number:</span> <%= raccno %></p>

<p><span>Amount Transferred:</span> <%= ub.getDeposit() %> USD</p>
